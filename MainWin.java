...
//Program Interface Variable
  ...
  JLabel lan = new JLabel();
  JTextField lanid = new JTextField();
...
findf.setBounds(200,150,300,300);
  ...
  ListModel model=new NameAndPicListModel(friendnames,picsonline);
    ...
    lan.setForeground(SystemColor.activeCaption);
    lan.setText("JAVA_LAN");
    lan.setBounds(new Rectangle(163, 39, 64, 18));
    lanid.setBounds(new Rectangle(257, 37, 96, 22));
    send.setIcon(icon1);
    send.setText("Send");
...
contentPane.add(jButton1, null);
    ...
    senddiapane.add(lan, null);
    senddiapane.add(lanid, null);
...
lanid.setText(friendjid.get(index).toString());
